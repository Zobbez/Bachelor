            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="profile.php" style="color:white;"><i class="fa fa-fw fa-user"></i> Profile</a>
                        </li>
                       
                        <li class="divider"></li>
                        <li>
                            <a href="../includes/logout.php" style="color:white;"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            </ul>
